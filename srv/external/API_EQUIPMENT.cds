/* checksum : 15a0384a0c2738e956b763a728b14a07 */
@cds.external : true
...
@sap.label : 'Equipment'
entity API_EQUIPMENT.Equipment {
  ...
  to_Classification : Composition of many API_EQUIPMENT.EquipmentClass;
  @cds.ambiguous : 'missing on condition?'
  to_LongText : Composition of API_EQUIPMENT.EquipmentLongText;
  @cds.ambiguous : 'missing on condition?'
  to_Partner : Composition of many API_EQUIPMENT.EquipmentPartner;
  @cds.ambiguous : 'missing on condition?'
  to_Warranty : Composition of many API_EQUIPMENT.EquipmentWarranty;
} actions {
  ...
  ) returns API_EQUIPMENT.Equipment;
...
entity API_EQUIPMENT.EquipClassCharacteristicValue {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
  ...
  CharcToTime : Time;
  @cds.ambiguous : 'missing on condition?'
  to_Characteristic : Association to API_EQUIPMENT.EquipmentClassCharacteristic {  };
  @cds.ambiguous : 'missing on condition?'
  to_Equipment : Association to API_EQUIPMENT.Equipment {  };
};
...
entity API_EQUIPMENT.EquipmentClass {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
  ...
  Class : String(18);
  @cds.ambiguous : 'missing on condition?'
  to_Characteristic : Composition of many API_EQUIPMENT.EquipmentClassCharacteristic on to_Characteristic.ClassType = ClassType and to_Characteristic.ClassInternalID = ClassInternalID and to_Characteristic.Equipment = Equipment;
  @cds.ambiguous : 'missing on condition?'
  to_Equipment : Association to API_EQUIPMENT.Equipment {  };
};
...
entity API_EQUIPMENT.EquipmentClassCharacteristic {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
  ...
  to_Equipment : Association to API_EQUIPMENT.Equipment {  };
  @cds.ambiguous : 'missing on condition?'
  to_EquipmentClass : Association to API_EQUIPMENT.EquipmentClass {  };
  @cds.ambiguous : 'missing on condition?'
  to_Value : Composition of many API_EQUIPMENT.EquipClassCharacteristicValue on to_Value.ClassInternalID = ClassInternalID and to_Value.CharacteristicInternalID = CharacteristicInternalID and to_Value.Equipment = Equipment;
};
...
entity API_EQUIPMENT.EquipmentLongText {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
...
entity API_EQUIPMENT.EquipmentPartner {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
...
entity API_EQUIPMENT.EquipmentWarranty {
  @sap.display.format : 'UpperCase'
  @sap.label : 'Equipment'
  @sap.quickinfo : 'Equipment Number'
  @sap.updatable : 'false'
